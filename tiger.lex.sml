...
ESC | STRING | COMMENT | FORMAT | INITIAL
...
fun yyAction19 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT; commentsClosed := false; continue()))
...
fun yyAction24 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("strings can not be splited to separate lines " ^ 
...
fun yyQ46 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction38(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ109(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
...
fun yyQ22 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction21(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ23(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
